...
class Vertex:
    ...
    number_of_types = 0  # Количество разных типов процессоров
    ...
    def __init__(self, requests):
        ...
        # Найти каналы:
        self.able_to_receive = [None] * Vertex.number_of_types  # Те, по которым запрос можно принять
        self.able_to_send = [None] * Vertex.number_of_types  # Те, по которым запрос можно отправить
        for i in range(0, Vertex.number_of_types):
...
def get_equations(config):  # Вернуть систему уравнений для данной конфигурации в виде списка из строк
    ...
    counter = [0]
    requests = [None] * Vertex.number_of_types
...
if __name__ == "__main__":
    ...
    m = [5, 3]  # Задать конфигурацию системы
    # Инициализация класса
    Vertex.max_requests = m
    Vertex.number_of_types = len(Vertex.max_requests)
